                ...
                <div class="row">
                    ...
                    if ($patientId) {
                        print "<div class='col-lg-4'>"
                              ."<a href = 'file.php' class = 'btn btn-success'> File a New Claim</a>"
                              ."</div>";
                    }
                    ?>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if ($patientId) {
                                                ...
                                                $list = $claimDAO->listByPatient($patientId);
                                            } else {
                                                $list = $claimDAO->listPending();
                                            }
                                            foreach ($list as $claim) {
                                                ...
                                                if ($patientId) {
                                                    print  "<td>"
                                                        . "<a class = 'delete' href = '../../controle/removeClaim.php?id=" . $claim->getId() . "'>Remove</a>"
                                                        . "</td>"
                                                        . "</tr>";
