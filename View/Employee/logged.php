...
if (isset($_SESSION['employee'])) {
    $employee = $employeeDAO->get($_SESSION['employee']);
    ?>
    <!DOCTYPE html>
    <html>
        <head>
        ...
        <body>
            ...
            <section id="services" class="bg-light-gray">
                <div class="container">
                    <h4> Hello <?php echo $employee->getUsername(); ?>,</h4>
                    <p>
                        ...
                        <div class="col-md-6">
                            <a href="../Filling_Claim/list.php" class="optionsDoctor">
                                <span class="fa-stack fa-4x">
                                    ...
                                    <i class="fa fa fa-files-o fa-stack-1x fa-inverse"></i>
                                </span>
                            </a>
                            <h4 class="service-heading">See New Claims</h4>
                        </div>

                        <div class="col-md-6">
                            <a href="../Filling_Claim/listApproved.php" class="optionsDoctor">
                                <span class="fa-stack fa-4x">
                                    <i class="fa fa-circle fa-stack-2x text-success"></i>
                                    <i class="fa fa-check fa-stack-1x fa-inverse"></i>
                                </span>
                            </a>
                            <h4 class="service-heading">See Approved Claims</h4>
                        </div>
